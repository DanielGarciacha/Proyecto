...
app.config['MYSQL_DB'] = 'mi_base_datos' #cambiar a TU base de datojs para que todo corra y funcione de manera acorde
app.config['JWT_SECRET_KEY'] = 'DAVIDANI3L@BQUIL4!'  # Cambia esto por una clave secreta segura
...
def cerrar_sesion():
    # Limpiar la sesión del servidor
    session.clear()
    # Asegurarse de que la respuesta indique al cliente que borre el localStorage
    return jsonify({
        "success": True, 
